...
info "====================================================="
info "После перезагрузки или повторного входа в систему, включите расширения вручную:"
info "  bash $REPO_ROOT/scripts/system/enable-extensions.sh"
info "или используйте GNOME Extensions в настройках GUI."
info "====================================================="
